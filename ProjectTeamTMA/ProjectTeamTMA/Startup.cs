...
namespace ProjectTeamTMA
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //{
            //    c.SwaggerDoc("v1", new OpenApiInfo { Title = "ProjectTeamTMA", Version = "v1" });
            //});
            ...
            services.AddAutoMapper(typeof(MapExtensions).Assembly);
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ProjectTeamTMA v1"));
            }
